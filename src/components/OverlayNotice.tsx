...
//   open?: boolean;
//   /** Auto dismiss duration in ms (set 0 to disable auto-dismiss) */
//   durationMs?: number;
...
//   message?: string;
//   ctaLabel?: string;
//   /** If true, do not animate (respects reduced motion as well) */
//   reduceMotion?: boolean;
//   /** If true, show only once per session (uses sessionStorage) */
...
//   // Honor prefers-reduced-motion if not explicitly disabled
//   const prefersReduced = usePrefersReducedMotion();
//   const doAnimate = !reduceMotion && !prefersReduced;

//   // Show only once per session if key provided
//   React.useEffect(() => {
...
//   // Focus the CTA on mount (accessibility)
//   React.useEffect(() => {
//     if (!visible) return;
...
//                   type="button"
//                   onClick={handleClose}
//                   className={`inline-flex items-center justify-center rounded-2xl px-4 py-2 font-medium text-white ${theme.accentGrad} hover:opacity-95 transition ${theme.focusRing} ${theme.target}`}
//                 >
//                   {ctaLabel}
//                 </button>
//                 <button
//                   type="button"
//                   onClick={handleClose}
//                   className={`inline-flex items-center justify-center rounded-2xl px-4 py-2 font-medium hover:opacity-90 transition ${theme.card} ${theme.focusRing} ${theme.target}`}
//                 >
//                   Zamknij
//                 </button>
//               </div>
